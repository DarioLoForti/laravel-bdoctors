        ...
        <div class="row">
            ...
            <div class="col-12 mt-4 ">
                ...
                <div>
                    ...
                    <span>Numero di telefono: {{ $doctor->phone }}</span>
                    <span>Città: {{ $doctor->city }}</span>
                ...
                <div class="d-flex">
                    <a href="{{ route('admin.doctors.edit', ['doctor' => $doctor->id]) }}" class="mx-2"><button
                            class="btn btn-sm btn-square btn-warning"><i class="fa-regular fa-pen-to-square"
                                style="color: #ffffff;"></i></button></a>
                    <button class="btn btn-sm btn-square btn-danger" data-bs-toggle="modal"
                        data-bs-target="#modal_project_delete-{{ $doctor->id }}"><i class="fa-solid fa-trash"
