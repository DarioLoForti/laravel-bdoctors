                                ...
                                <div class="accordion-item ">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed d-none d-lg-flex" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#reviewCollapse{{ $loop->index }}"
                                            aria-expanded="false" aria-controls="reviewCollapse{{ $loop->index }}">
                                            <div class="container d-flex justify-content-between ">
                                                ...
                                                <div>
                                                    <span
                                                        class="message-text date">{{ $review->created_at->format('d-m-Y H:i') }}</span>
                                                </div>
                                            ...
                                            <div class="container d-flex justify-content-between ">
                                                <div>
                                                    <strong>{{ $review->name }}</strong> &nbsp;<span
                                                        class="d-none d-sm-block">email: {{ $review->email }}</span>
                                                </div>
